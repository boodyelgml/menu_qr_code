...
(1, 'admin', 'admin@scanner.com', NULL, '$2y$10$/dAwzctukrsJvPsIrAXaiO5rxWJU2eQeawWBi54sdFfuF0o5Emnc6', 1, 123456789, NULL, NULL, '2020-07-06 02:39:39', '2020-07-06 02:39:39');
...
ALTER TABLE `answers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `answers_restaurant_id_foreign` (`restaurant_id`),
...
ALTER TABLE `answers`
  ...
  ADD CONSTRAINT `answers_restaurant_id_foreign` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`id`) ON DELETE CASCADE;
